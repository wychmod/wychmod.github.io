...
- 🤖 **AI AGENT**
  ...
  - **Agent 方法论与协议实践**
    - [AI方法论](md/agent/agent开发知识/AI方法论.md)
    - [agent五种设计模式](md/agent/agent系统知识/agent五种设计模式.md)
  ...
  - **视觉模型与工程实践**
    ...
    - <a href="https://wychmod.github.io/md/人工智能/LBP特征及其变体和python实现.pdf" target="_blank">LBP特征及其变体和python实现</a>
