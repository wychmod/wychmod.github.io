...
————————Redis7.X————————
docker run -itd --name xdclass-redis -p 6379:6379 -v /mydata/redis/data:/data redis:7.0.8 --requirepass 123456
...
-e MYSQL_SERVICE_HOST=117.72.218.181 \
-e MYSQL_SERVICE_PORT=3306 \
-e MYSQL_SERVICE_USER=root \
-e MYSQL_SERVICE_PASSWORD=penghan123 \
...
-e MINIO_ROOT_PASSWORD="penghan123" \
-e MINIO_DEFAULT_BUCKETS="bucket" \
-e "MINIO_SERVER_URL=http://117.72.218.181:9000" \
