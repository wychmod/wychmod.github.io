...
![](../../youdaonote-images/Pasted%20image%2020221208163001.png)
...
另外，_1073741823_ 等于 2^{30} - 1230−1 ，是每个数组元素能表示的最大数值，可与十进制中的 _9_ 类比。
...
![](../../youdaonote-images/Pasted%20image%2020221208163320.png)