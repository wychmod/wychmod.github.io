...
![image.png](https://note.youdao.com/yws/res/a/WEBRESOURCE68c5796f44bcfddbfb65f0bb90fc29ca)
...
![image.png](https://note.youdao.com/yws/res/b/WEBRESOURCEeea1d80a6170e185d425553d6ba4ac9b)
```python
def quick_sort3(arr):
...
![image.png](https://note.youdao.com/yws/res/9/WEBRESOURCE5a5e296b2c031838b7d6d1e4ba8c5ee9)
...
```
#### 为什么从下建堆比从上建堆快
![image.png](https://note.youdao.com/yws/res/0/WEBRESOURCE00fcf7ad969a56a1935df5c08a844ca0)
从下建堆 多的代价小 少的代价大
从上建堆 多的代价大 少的代价小
...
![image.png](https://note.youdao.com/yws/res/6/WEBRESOURCE2175bf8c538bdb5285d7172c9229b1c6)
...
![image.png](https://note.youdao.com/yws/res/8/WEBRESOURCEd69ce290d3a24e22ab665820003e71d8)
...
**3.两个都有环**
![image.png](https://note.youdao.com/yws/res/6/WEBRESOURCEbbce6badf8894f29403030e3799029a6)
1. 先判断第二种，如果不是第二种，那么让loop1（第一个入环节点）转一圈看有没有遇到loop2，如果没有遇到那就是返回null，如果遇见返回loop1或者loop2都行
2. 第二种先判断入环节点是不是同一个，如果是就不用考虑了，光考虑前面的。
![image.png](https://note.youdao.com/yws/res/2/WEBRESOURCE86cef6fee8424f80f2d993a4ed188272)
...
![image.png](https://note.youdao.com/yws/res/6/WEBRESOURCE4e3503b377530173f821db56311afb46)
...
![image.png](https://note.youdao.com/yws/res/6/WEBRESOURCE9bb4693da68c91412ec595922c613776)
...
![image.png](https://note.youdao.com/yws/res/3/WEBRESOURCE916ff2762af9dfa71131dbaa04f2abe3)
...
## 哈希表
![image.png](https://note.youdao.com/yws/res/1/WEBRESOURCEe8914b4aa70028f66dc95614933bdfc1)
### 有序表
