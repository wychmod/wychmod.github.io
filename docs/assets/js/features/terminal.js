...
(function() {
  ...
  const Commands = {
    ...
    whoami: function() {
      addOutput('<span class="terminal-success">wychmod - 24届人工智能研究生 | AI 应用开发者</span>');
      addOutput('<span class="terminal-info">Java · Python · AI Agent 应用开发者</span>');
    },
    ...
    about: function() {
      ...
      addOutput(`<span class="terminal-info">💻 技术栈：</span> Java, Python, AI Agent, React, Vue, Redis, MySQL, K8s...`);
    ...
    readme: function() {
      addOutput('<span class="terminal-success">========== wychmod 技术知识库 ==========</span>');
      addOutput('');
      addOutput('<span class="terminal-info">👨‍💻 关于我：</span>24届人工智能研究生，Java/Python 与 AI Agent 应用开发者');
